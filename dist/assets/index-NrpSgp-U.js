 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _t="WebChannelConnection";class FR extends LR{constructor(e){super(e),this.c_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}Jo(e,n,r,s,i){const o=jc();return new Promise(((l,c)=>{const u=new mg;u.setWithCredentials(!0),u.listenOnce(gg.COMPLETE,(()=>{try{switch(u.getLastErrorCode()){case Go.NO_ERROR:const p=u.getResponseJson();te(_t,`XHR for RPC '${e}' ${o} received:`,JSON.stringify(p)),l(p);break;case Go.TIMEOUT:te(_t,`RPC '${e}' ${o} timed out`),c(new se(z.DEADLINE_EXCEEDED,"Request time out"));break;case Go.HTTP_ERROR:const m=u.getStatus();if(te(_t,`RPC '${e}' ${o} failed with status:`,m,"response text:",u.getResponseText()),m>0){let v=u.getResponseJson();Array.isArray(v)&&(v=v[0]);const O=v?.error;if(O&&O.status&&O.message){const D=(function(M){const L=M.toLowerCase().replace(/_/g,"-");return Object.values(z).indexOf(L)>=0?L:z.UNKNOWN})(O.status);c(new se(D,O.message))}else c(new se(z.UNKNOWN,"Server responded with status "+u.getStatus()))}else c(new se(z.UNAVAILABLE,"Connection failed."));break;default:fe(9055,{l_:e,streamId:o,h_:u.getLastErrorCode(),P_:u.getLastError()})}}finally{te(_t,`RPC '${e}' ${o} completed.`)}}));const f=JSON.stringify(s);te(_t,`RPC '${e}' ${o} sending request:`,s),u.send(n,"POST",f,r,15)}))}T_(e,n,r){const s=jc(),i=[this.Uo,"/","google.firestore.v1.Firestore","/",e,"/channel"],o=vg(),l=yg(),c={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},u=this.longPollingOptions.timeoutSeconds;u!==void 0&&(c.longPollingTimeout=Math.round(1e3*u)),this.useFetchStreams&&(c.useFetchStreams=!0),this.jo(c.initMessageHeaders,n,r),c.encodeInitMessageHeaders=!0;const f=i.join("");te(_t,`Creating RPC '${e}' stream ${s}: ${f}`,c);const p=o.createWebChannel(f,c);this.I_(p);let m=!1,v=!1;const O=new UR({Yo:N=>{v?te(_t,`Not sending because RPC '${e}' stream ${s} is closed:`,N):(m||(te(_t,`Opening RPC '${e}' stream ${s} transport.`),p.open(),m=!0),te(_t,`RPC '${e}' stream ${s} sending:`,N),p.send(N))},Zo:()=>p.close()}),D=(N,M,L)=>{N.listen(M,(k=>{try{L(k)}catch(S){setTimeout((()=>{throw S}),0)}}))};return D(p,bi.EventType.OPEN,(()=>{v||(te(_t,`RPC '${e}' stream ${s} transport opened.`),O.o_())})),D(p,bi.EventType.CLOSE,(()=>{v||(v=!0,te(_t,`RPC '${e}' stream ${s} transport closed`),O.a_(),this.E_(p))})),D(p,bi.EventType.ERROR,(N=>{v||(v=!0,zs(_t,`RPC '${e}' stream ${s} transport errored. Name:`,N.name,"Message:",N.message),O.a_(new se(z.UNAVAILABLE,"The operation could not be completed")))})),D(p,bi.EventType.MESSAGE,(N=>{if(!v){const M=N.data[0];De(!!M,16349);const L=M,k=L?.error||L[0]?.error;if(k){te(_t,`RPC '${e}' stream ${s} received error:`,k);const S=k.status;let j=(function(y){const E=Qe[y];if(E!==void 0)return Zg(E)})(S),Z=k.message;j===void 0&&(j=z.INTERNAL,Z="Unknown error status: "+S+" with message "+k.message),v=!0,O.a_(new se(j,Z)),p.close()}else te(_t,`RPC '${e}' stream ${s} received:`,M),O.u_(M)}})),D(l,_g.STAT_EVENT,(N=>{N.stat===Pc.PROXY?te(_t,`RPC '${e}' stream ${s} detected buffering proxy`):N.stat===Pc.NOPROXY&&te(_t,`RPC '${e}' stream ${s} detected no buffering proxy`)})),setTimeout((()=>{O.__()}),0),O}terminate(){this.c_.forEach((e=>e.close())),this.c_=[]}I_(e){this.c_.push(e)}E_(e){this.c_=this.c_.filter((n=>n===e))}}function tc(){return typeof document<"u"?document:null}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class on{constructor(e,n){this.bucket=e,this.path_=n}get path(){return this.path_}get isRoot(){return this.path.length===0}fullServerUrl(){const e=encodeURIComponent;return"/b/"+e(this.bucket)+"/o/"+e(this.path)}bucketOnlyServerUrl(){return"/b/"+encodeURIComponent(this.bucket)+"/o"}static makeFromBucketSpec(e,n){let r;try{r=on.makeFromUrl(e,n)}catch{return new on(e,"")}if(r.path==="")return r;throw T0(e)}static makeFromUrl(e,n){let r=null;const s="([A-Za-z0-9.\\-_]+)";function i(S){S.path.charAt(S.path.length-1)==="/"&&(S.path_=S.path_.slice(0,-1))}const o="(/(.*))?$",l=new RegExp("^gs://"+s+o,"i"),c={bucket:1,path:3};function u(S){S.path_=decodeURIComponent(S.path)}const f="v[A-Za-z0-9_]+",p=n.replace(/[.]/g,"\\."),m="(/([^?#]*).*)?$",v=new RegExp(`^https?://${p}/${f}/b/${s}/o${m}`,"i"),O={bucket:1,path:3},D=n===Ay?"(?:storage.googleapis.com|storage.cloud.google.com)":n,N="([^?#]*)",M=new RegExp(`^https?://${D}/${s}/${N}`,"i"),k=[{regex:l,indices:c,postModify:i},{regex:v,indices:O,postModify:u},{regex:M,indices:{bucket:1,path:2},postModify:u}];for(let S=0;S<k.length;S++){const j=k[S],Z=j.regex.exec(e);if(Z){const I=Z[j.indices.bucket];let y=Z[j.indices.path];y||(y=""),r=new on(I,y),j.postModify(r);break}}if(r==null)throw w0(e);return r}}class b0{constructor(e){this.promise_=Promise.reject(e)}getPromise(){return this.promise_}cancel(e=!1){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function A0(t,e,n){let r=1,s=null,i=null,o=!1,l=0;function c(){return l===2}let u=!1;function f(...N){u||(u=!0,e.apply(null,N))}function p(N){s=setTimeout(()=>{s=null,t(v,c())},N)}function m(){i&&clearTimeout(i)}function v(N,...M){if(u){m();return}if(N){m(),f.call(null,N,...M);return}if(c()||o){m(),f.call(null,N,...M);return}r<64&&(r*=2);let k;l===1?(l=2,k=0):k=(r+Math.random())*1e3,p(k)}let O=!1;function D(N){O||(O=!0,m(),!u&&(s!==null?(N||(l=2),clearTimeout(s),p(0)):N||(l=1)))}return p(0),i=setTimeout(()=>{o=!0,D(!0)},n),D}function R0(t){t(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
