    ...
    <div class="modal_overlay" role="dialog" aria-modal="true" aria-labelledby="modal-title">
        <div class="modal_holder">
            ...
            <div class="modal_content_holder inter font_size_xs">
                <div class="modal_avatars_holder" v-for="avatar in avatars">
                    <div class="modal_avatar_selected" v-if="avatar.ref == selectedAvatar"
                        @click="selectAvatar(avatar.ref)" :style="{
                    ...
                    <div class="modal_avatar" v-else :style="{
                        backgroundImage: `url(${avatar.url})`,
                        backgroundSize: '100% 100%',
                        backgroundPosition: 'center center',
                        backgroundRepeat: 'no-repeat'
