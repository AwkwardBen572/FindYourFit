<template>
    <div class="mood_tracker_holder">
        ...
        <div class="mood_icons_holder">
            <div class="mood_icon_holder" v-for="mood in moods">
                <div :class="mood.icon"
                ...
                <!-- <div class="mood_icon_ref_holder inter font_size_xxs">
                {{ mood.label }}
            </div> -->
            </div>
        </div>
        <div class="influence_holder" style="height: 25rem;">
            <div class="influence_heading_holder inter font_size_xs">
                <b>What might be influencing this?</b>
            </div>
